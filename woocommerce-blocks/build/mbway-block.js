...
const Content = props => {
  ...
  const [mbwayPhoneNumber, setMbwayPhoneNumber] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(''); //This works but mbwayPhoneNumber is not available inside onPaymentProcessing below
  const {
    eventRegistration,
    emitResponse
  } = props;
