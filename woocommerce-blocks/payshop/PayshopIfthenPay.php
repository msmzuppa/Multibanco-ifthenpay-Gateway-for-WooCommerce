...
final class PayshopIfthenPay extends AbstractPaymentMethodType {
	...
	public function get_payment_method_script_handles() {
		wp_register_script( 'wc-payment-method-payshop-ifthenpay', plugins_url( 'build/index.js', __FILE__ ), array(), WC_IfthenPay_Webdados()->get_version().( WP_DEBUG ? '.'.rand( 0, 9999 ) : '' ), true );
